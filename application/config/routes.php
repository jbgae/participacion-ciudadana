...
$route['departamentos/ajax'] = "departamento/registrarAjax";
$route['departamento/ajax']  = "departamento/empleados";
$route['empleado'] = "incidente/historial";
$route['empleados'] = "empleado/registrar";
$route['empleado/registrarAjax'] = "empleado/registrarAjax";
$route['empleado/eliminar/(:any)'] = "empleado/eliminar/$1";
$route['departamento/eliminar/$1'] = "departamento/eliminar/$1";
